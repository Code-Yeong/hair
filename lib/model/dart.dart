...
class Doodle {
  ...
  final Icon icon;
  final Widget child;
  const Doodle({this.title, this.time, this.child, this.icon, this.iconBackground});
}
...
//    doodle: "https://www.google.com/logos/doodles/2016/abd-al-rahman-al-sufis-azophi-1113th-birthday-5115602948587520-hp2x.jpg",
...
//    doodle: "https://www.google.com/logos/doodles/2015/abu-al-wafa-al-buzjanis-1075th-birthday-5436382608621568-hp2x.jpg",
//    icon: Icon(Icons.check, color: Colors.white),
//    iconBackground: Colors.cyan,
//  ),
//  Doodle(
...
//    doodle: "https://lh3.googleusercontent.com/ZTlbHDpH59p-aH2h3ggUdhByhuq1AfviGuoQpt3QqaC7bROzbKuARKeEfggkjRmAwfB1p4yKbcjPusNDNIE9O7STbc9C0SAU0hmyTjA=s660",
//    icon: Icon(Icons.check, color: Colors.white),
//    iconBackground: Colors.cyan,
//  ),
//  Doodle(
...
//      doodle: "https://www.google.com/logos/doodles/2018/ibn-sinas-1038th-birthday-5768556863029248.2-2x.png",
//      icon: Icon(
//        Icons.healing,
//        color: Colors.white,
//      ),
...
//      doodle: "https://lh3.googleusercontent.com/vk5ODrDXkJXCJ9z2lMnQdMb9m5-HKxDvn_Q67J8PBKPT9n67iCQFj37tB62ARaQQKnKwig-CcBT9NODmzoqdM56_UTUKZRELLYoz1lVU=s800",
//      icon: Icon(
//        Icons.blur_circular,
//        color: Colors.white,
//      ),
...
//      doodle: "https://lh3.googleusercontent.com/UBa5VOLYZNb9sqCZJeMrrS5ZW-KpDBZ7haT8aLPpHzeOZ8K_6TCP03_n-5VKIaewaRVqYkTF09OwvI4oQ2L2IqaUyWlTUkJb4E1uZF0=s660",
//      icon: Icon(
//        Icons.category,
//        color: Colors.white,
//      ),
...
//      doodle: "https://lh3.googleusercontent.com/429NetsPejpMgeXqZuA15mCFLQykowhHNnbkSa1L8SHq9Kp9De-EBPlmOknzJ_HRykzt5FPhwpju_M3uKeuZlKegwdRQSzrH8NfdwR_B=s660",
//      icon: Icon(
//        Icons.navigation,
//        color: Colors.white,
//        size: 32.0,
...
//      doodle: "https://lh3.googleusercontent.com/TegzHFZQYIfV4lYsaXsZ-CUE_9Lp6qbJZXpSRzTWeLkNiQh0xRbt5KsI4szxN9nUopbyH6d-8tkmV5NcUJtI0Ks79fh-D6nCrKEt5hxR=s660",
//      icon: Icon(
